...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('signed_up_by', models.CharField(blank=True, max_length=40, verbose_name='Signed up by')),
                ...
                ('confirmation_code', models.CharField(blank=True, max_length=40, null=True, verbose_name='Confirmation code')),
